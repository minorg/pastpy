        ...
        def set_cat(self, cat):
            ...
            if cat is not None:
                if not isinstance(cat, pastpy.lib.models.cat.Cat):
                    raise TypeError("expected cat to be a pastpy.lib.models.cat.Cat but it is a %s" % builtins.type(cat))
            self.__cat = cat
            return self
        ...
        def set_condition(self, condition):
            ...
            if condition is not None:
                if not isinstance(condition, pastpy.lib.models.condition.Condition):
                    raise TypeError("expected condition to be a pastpy.lib.models.condition.Condition but it is a %s" % builtins.type(condition))
            self.__condition = condition
            return self
        ...
        def set_ew(self, ew):
            ...
            if ew is not None:
                if not isinstance(ew, pastpy.lib.models.cardinal_direction.CardinalDirection):
                    raise TypeError("expected ew to be a pastpy.lib.models.cardinal_direction.CardinalDirection but it is a %s" % builtins.type(ew))
            self.__ew = ew
            return self
        ...
        def set_ns(self, ns):
            ...
            if ns is not None:
                if not isinstance(ns, pastpy.lib.models.cardinal_direction.CardinalDirection):
                    raise TypeError("expected ns to be a pastpy.lib.models.cardinal_direction.CardinalDirection but it is a %s" % builtins.type(ns))
            self.__ns = ns
            return self
