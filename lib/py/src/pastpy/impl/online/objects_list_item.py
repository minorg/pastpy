...
class ObjectsListItem(object):
    class Builder(object):
        ...
        def build(self):
            return ObjectsListItem(detail_href=self.__detail_href, record_type=self.__record_type, thumbnail_src=self.__thumbnail_src, title=self.__title)
        ...
        def set_thumbnail_src(self, thumbnail_src):
            ...
            if thumbnail_src is None:
                raise ValueError('thumbnail_src is required')
    ...
    class FieldMetadata(object):
        ...
        @classmethod
        def values(cls):
            return (cls.DETAIL_HREF, cls.RECORD_TYPE, cls.THUMBNAIL_SRC, cls.TITLE,)
    ...
    def __hash__(self):
        return hash((self.detail_href, self.record_type, self.thumbnail_src, self.title,))

    def __iter__(self):
        return iter((self.detail_href, self.record_type, self.thumbnail_src, self.title,))
