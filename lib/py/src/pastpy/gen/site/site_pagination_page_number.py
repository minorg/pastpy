...
class SitePaginationPageNumber(object):
    class Builder(object):
        ...
        def build(self):
            return SitePaginationPageNumber(active=self.__active, enabled=self.__enabled, number=self.__number)
        ...
        def from_template(cls, template):
            '''
            :type template: pastpy.gen.site.site_pagination_page_number.SitePaginationPageNumber
        ...
        def update(self, site_pagination_page_number):
            '''
            :type active: bool
            :type enabled: bool
            :type number: int
            ...
            if isinstance(site_pagination_page_number, SitePaginationPageNumber):
                self.set_active(site_pagination_page_number.active)
                self.set_enabled(site_pagination_page_number.enabled)
                self.set_number(site_pagination_page_number.number)
            elif isinstance(site_pagination_page_number, dict):
                for key, value in site_pagination_page_number.items():
                    getattr(self, 'set_' + key)(value)
            else:
                raise TypeError(site_pagination_page_number)
            return self
    ...
    def __repr__(self):
        ...
        return 'SitePaginationPageNumber(' + ', '.join(field_reprs) + ')'
    ...
    def write(self, oprot):
        ...
        oprot.write_struct_begin('SitePaginationPageNumber')
