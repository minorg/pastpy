...
class SiteIndex(object):
    class Builder(object):
        ...
        def build(self):
            return SiteIndex(configuration=self.__configuration, current_year=self.__current_year, nav_items=self.__nav_items, root_relative_href=self.__root_relative_href)
        ...
        def update(self, site_index):
            ...
            if isinstance(site_index, SiteIndex):
                self.set_configuration(site_index.configuration)
                self.set_current_year(site_index.current_year)
                self.set_nav_items(site_index.nav_items)
                self.set_root_relative_href(site_index.root_relative_href)
